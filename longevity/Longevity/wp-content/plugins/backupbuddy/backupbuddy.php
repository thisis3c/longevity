...
// Cron looback test. 
function bub_testing_cronback() {
	$time = microtime(true);
	require_once( pb_backupbuddy::plugin_path() . '/classes/core.php' );
	require_once( pb_backupbuddy::plugin_path() . '/classes/fileoptions.php' );
	$cronback_test = new pb_backupbuddy_fileoptions( backupbuddy_core::getLogDirectory() . 'fileoptions/cronback-test.txt', false, false, true );
	$cronback_test->options = $time;
	$cronback_test->save();
}
add_action( 'bub_test_cronback', 'bub_testing_cronback' );
