...
<div class="wrap">
	...
	<h2><?php _e( 'Slick Slider and Image Carousel - Join the Membership', 'wp-slick-slider-and-image-carousel' ); ?></h2><br />
				...
				<div class="table-option clearfix">
					<h3>Ultimate</h3>
					   ...
					   <div class="footer clearfix">
							<a class="button button-primary button-large" target="_blank" href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&amp;download_id=14791&amp;edd_options[price_id]=4&ref=wposthemeplugin">Purchase</a>
                        </div>
				</div>			
			</div>
			<div class="medium-3 columns best-value">
				<div class="table-option clearfix">
					...
					<ul class="table-option-ul clearfix">
					   ...
					   <div class="footer clearfix">
							<a class="button button-primary button-large" target="_blank" href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&amp;download_id=14791&amp;edd_options[price_id]=2&ref=wposthemeplugin">Purchase</a>
                        </div>
				</div>			
			</div>
			<div class="medium-3 columns">
				<div class="table-option clearfix">
					...
					<ul class="table-option-ul clearfix">
					   ...
					   <div class="footer clearfix">
							<a class="button button-primary button-large" target="_blank" href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&amp;download_id=14791&amp;edd_options[price_id]=1&ref=wposthemeplugin">Purchase</a>
                        </div>
			...
			<div class="medium-3 columns">
				<div class="table-option clearfix">
					...
					<ul class="table-option-ul clearfix">
					   ...
					   <div class="footer clearfix">
							<a class="button button-primary button-large" target="_blank" href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&amp;download_id=14791&amp;edd_options[price_id]=3&ref=wposthemeplugin">Purchase</a>
                        </div>				
				</div>			
			</div>		
		</div>
